...
public class EspecialidadControlador {
    ...
    @Autowired
    private final EspecialidadServicio especialidadServicio =null;
    ...
    public ResponseEntity<?> saveEspecialidad(@Valid @RequestBody Especialidades especialidades, BindingResult result){
        ...
        try{
            Especialidades especialidades1=especialidadServicio.guardarEspecialidad(especialidades);
    ...
    public ResponseEntity<?> listarEspecialidades() {
        ...
        try {
            List<Especialidades> especialidades = especialidadServicio.listarEspecialidades();
    ...
    public ResponseEntity<?> buscarEspecialidadPorId(@PathVariable Long id) {
        ...
        try {
            Optional<Especialidades> especialidad = especialidadServicio.obtenerEspecialidadesPorId(id);
